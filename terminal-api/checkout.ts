...
export const turnOnScreensaver = (config: ConfigurationSchema, logger: ILogger, delayInMillis: number
    ) => httpRequest('actions', "POST", '{"action": "toggle_screensaver", "data": {"screensaver_enabled": true}}', config, logger, delayInMillis)

export const turnOffScreensaver = (config: ConfigurationSchema, logger: ILogger, delayInMillis: number
    ) => httpRequest('actions', "POST", '{"action": "toggle_screensaver", "data": {"screensaver_enabled": false}}', config, logger, delayInMillis)
